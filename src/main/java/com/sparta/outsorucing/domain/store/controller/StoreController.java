...
public class StoreController {
    ...
    // 가게목록 조회(사장님 화면)
    @GetMapping("/owners")
    public List<StoreResponseDto> findStoreOwner(@Auth AuthMember authMember){
        return storeService.findStoreOwner(authMember.getId(), String.valueOf(authMember.getMemberRole()));
    }
